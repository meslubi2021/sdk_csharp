...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NotificationFilterUrlMonetaryAccount : BunqModel
    {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "NotificationFilterUrl")]
        public NotificationFilterUrl NotificationFilterUrl { get; set; }
        ...
        public static BunqResponse<List<NotificationFilterUrlMonetaryAccount>> Create(int? monetaryAccountId= null, List<NotificationFilterUrl> notificationFilters = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_NOTIFICATION_FILTERS, notificationFilters},
            ...
            return FromJsonList<NotificationFilterUrlMonetaryAccount>(responseRaw);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<NotificationFilterUrlMonetaryAccount>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            if (this.NotificationFilterUrl != null)
            {
                return false;
            }
